...
import com.wignersantos.workshopmongo.dto.AuthorDTO;
...
public class Instantiation implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		...
		Post post1 = new Post(null, sdf.parse("21/03/2018"), "Partiu viagem", "Vout viajar para São Paulo. Abraços!", new AuthorDTO(maria));
